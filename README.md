...
BellaBeat is a tech driven fitness company focused on women's health. 
Since they launched in 2013 they are trying to gather data and insights into their customers so the company can continue to grow globally.

## **Ask**
**Business Task:** Analyze fitness data from users to gain insights into how it is being used to guide the marketing analytics team for continued global growth of BellaBeat.
...
total_daily_activity %>%
  ...
  summary()
```
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/f8b9af4d-ce69-4ad1-b32e-473d38e05a34)
...
no_zero_activity %>%
  ...
  summary()
  ```
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/88153143-a2c9-4fd1-a17e-6296f0714af4)
...
ggplot(data = weekday_avgsteps, aes(x = weekday,y = daily_avgsteps)) + geom_col(fill = "#336699") + 
  ...
  ```
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/e14d2a09-8923-43bd-9b0a-8cebe73a8b91)
...
```
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/78a9b4f7-556b-47f5-a8af-8c4eed9efe98)
...
ggplot(data = hours_avgcalories, aes(x = time, y = hourly_avg)) +
  ...
  theme(axis.text.x = element_text(angle = 90))
```
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/1ecc9809-f944-4a47-9f41-e131d8cc30fb)
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/9ddd6333-cf18-42c6-829b-118d803a63e6)
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/58fa6bdb-461c-4451-8e5c-1a79e92ca136)
...
```
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/43932b40-8823-43f9-90da-dc886db1d797)
...
```
![image](https://github.com/br6067/BellaBeat-Google-Analytics-Capstone/assets/166944570/b311efa5-9338-4b34-9b5d-707f41f5a5e7)

Shows that for those that did track their weight through the app the majority did it manually.  

## **Share**

### [**BellaBeat Analysis Dashboard**](https://public.tableau.com/app/profile/ben.robinson7893/viz/BellaBeatAnalysisDashboard/BellaBeatAnalysisDashboard_1)


## **Act**

### **Recommendations for the marketing analytics team:**
